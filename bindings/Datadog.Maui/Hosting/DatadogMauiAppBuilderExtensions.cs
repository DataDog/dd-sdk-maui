...
namespace Datadog.Maui.Hosting
{
    /// <summary>
    ...
    public static class DatadogMauiAppBuilderExtensions
    {
        ...
        public static MauiAppBuilder UseDatadog(this MauiAppBuilder builder, DdSdkConfiguration configuration)
        {
            DdSdk.Initialize(configuration);
            return builder;
        }

        /// <summary>Enables Datadog Logs. Requires <see cref="UseDatadog"/> to have run first.</summary>
        ...
        /// <summary>Enables Datadog Trace. Requires <see cref="UseDatadog"/> to have run first.</summary>
        ...
        /// <summary>Enables Datadog Session Replay. Requires <see cref="UseDatadog"/> to have run first.</summary>
